...
class TestIGE256Random(unittest.TestCase):
    ...
    def test_ige256_random_{mode1}_{count}(self):
        ...
        a = supertg.ige256_{mode1}(data, key, iv)
        b = supertg.ige256_{mode2}(a, key, iv)
