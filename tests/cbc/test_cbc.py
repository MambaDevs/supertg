...
class TestCBC256NIST(unittest.TestCase):
    ...
    def test_cbc256_encrypt(self):
        ...
        self.assertEqual(supertg.cbc256_encrypt(plaintext, key, iv), ciphertext)
    ...
    def test_cbc256_decrypt(self):
        ...
        self.assertEqual(supertg.cbc256_decrypt(ciphertext, key, iv), plaintext)
...
class TestCBC256Cryptography(unittest.TestCase):
    ...
    def test_cbc256_{mode}_{name}_{count}(self):
        ...
        self.assertEqual(supertg.cbc256_{mode}({input}, key, iv), {output})
    """.replace("\n    ", "\n")
...
class TestCBC256Random(unittest.TestCase):
    ...
    def test_cbc256_random_{mode1}_{count}(self):
        ...
        a = supertg.cbc256_{mode1}(data, key, iv)
        b = supertg.cbc256_{mode2}(a, key, iv_copy)
